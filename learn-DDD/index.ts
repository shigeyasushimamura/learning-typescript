...
class User {
  ...
  constructor(id: string, sequenceNumber, email: string) {
    this.id = id;
    // this.name = name;
...
// 同じ属性値を持つ2つのユーザー
// const user1 = new User("1", "山田太郎", "taro@example.com");
// const user2 = new User("2", "山田太郎", "taro@example.com");
// const user3 = new User("1", "山田花子", "hanako@example.com");
